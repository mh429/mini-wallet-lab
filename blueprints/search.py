...
def search():
    ...
    param = (f"%{search_text}%", f"%{search_text}%", f"%{search_text}%", f"%{search_text}%", f"%{search_text}%")
    ...
    #画面を表示
    return render_template('search/search.html',products=products,search_text=search_text)
